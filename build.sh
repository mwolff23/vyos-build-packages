...
vybuilddeb_ext vyos-strongswan '' "/vyos/pkg_scripts/script_build.sh"
vybuilddeb_ext iproute2 '' "/vyos/pkg_scripts/script_build.sh" "https://github.com/mwolff23/vyos-iproute2.git"
vybuilddeb_ext python-inotify '' "/vyos/pkg_scripts/script_build.sh" "https://github.com/mwolff23/vyos-python-inotify"
